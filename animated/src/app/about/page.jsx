...
const Page = () => {
    ...
    <div id="about-section" className="relative min-h-screen w-full overflow-hidden mb-12">
      <div className="px-4 lg:px-16 flex ">
        ...
        <div className="w-full h-full lg:w-1/2 flex flex-col pt-6 sm:pt-8 lg:pt-16 ">
          {/* Biography */}
          <div className="">
            <h1 className="sm:text-sm md:text-xl lg:text-2xl font-bold transition-transform duration-500 hover:scale-105 animate-slide-up">
              Biography
            </h1>
            <div className=" mt-8 ml-8 space-y-4 text-sm sm:text-base lg:text-md font-light pr-0 lg:pr-8">
              <p className="transition-opacity duration-500 hover:opacity-80">
                ...
                in the tech industry. As a graduate of BS Computer Science from <span className="font-bold bg-gradient-to-r from-cyan-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">
                Government College University Faisalabad (GCUF),</span> I have honed my
                technical expertise through both academic and practical
                pursuits.
              </p>
              <p className="transition-opacity duration-500 hover:opacity-80">
                Currently, I work at <span className=" font-bold bg-gradient-to-r from-cyan-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">Bookme.pk,</span> Pakistan's first ticketing
                platform, where I contribute to developing innovative solutions
                that streamline online ticketing services. My experience
                includes building real-world projects, collaborating with teams,
          ...
          <div className="mt-8 sm:mt-4 lg:mt-12 space-y-6">
            ...
            <div className="flex justify-end pr-0 lg:pr-8">
              <Image
                className="w-28 mt-[-22px] sm:mt-[-21px] md:mt-2 lg:mt-4 h-8 mr-12 transition-transform duration-500 hover:scale-105"
                src={signatures}
                alt="signatures"
                priority
              />
  ...
  <div className="w-full h-full transition-transform duration-500 hover:scale-110 ">
    <Brain scrollYProgress={scrollYProgress} />
      ...
      {/* Skills Section */}
      <div className="mt-28 ml-8 mr-4 md:ml-8 md:mr-8 sm:mr-8 lg:ml-16 lg:mr-20">
        <Images />
